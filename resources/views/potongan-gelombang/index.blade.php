    ...
    <div class="overflow-x-auto rounded-xl border border-gray-200 bg-white shadow-sm">
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            <thead class="bg-gray-50 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">
                <tr><th class="px-4 py-3">Tahun Ajaran</th><th class="px-4 py-3">Gelombang</th><th class="px-4 py-3">Jenjang</th><th class="px-4 py-3 text-right">Potongan</th><th class="px-4 py-3 text-right">Masa Berlaku</th><th class="px-4 py-3">Status</th><th class="px-4 py-3 text-right">Aksi</th></tr>
                <tr class="bg-white">
                    <x-fcol :col="0" type="select" /><x-fcol :col="1" type="select" /><x-fcol :col="2" type="select" /><x-fcol type="blank" /><x-fcol type="blank" /><x-fcol :col="5" type="select" /><x-fcol type="blank" />
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-100">
                @forelse ($rows as $r)
                    <tr data-row class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <span class="rounded-full px-2 py-0.5 text-xs {{ $r->aktif ? 'bg-emerald-100 text-emerald-700' : 'bg-gray-100 text-gray-500' }}">{{ $r->aktif ? 'Aktif' : 'Arsip' }}</span>
                        </td>
                ...
                @empty
                    <tr><td colspan="7" class="px-4 py-10 text-center text-gray-400">Belum ada potongan gelombang.</td></tr>
                @endforelse
