                    ...
                    <tbody>
                        <template x-for="(row, i) in rows" :key="i">
                            <tr class="border-t border-gray-100 align-top">
                                ...
                                <td class="px-2 py-1.5"><input type="number" step="0.01" min="0" :name="`details[${i}][harga_satuan]`" x-model="row.harga_satuan" class="w-full rounded border border-gray-400 px-2 py-1.5 text-right text-sm focus:border-brand focus:ring-1 focus:ring-brand"></td>
